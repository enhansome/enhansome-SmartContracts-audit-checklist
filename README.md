# Awesome SmartContracts-audit-checklist with stars
...
Before starting the audits you need to know about the projects codebase. You can easily do this task using [Consensys](https://diligence.consensys.net)'s [Solidity-Code-Metrics](https://github.com/ConsenSys/solidity-metrics) ⭐ 294 | 🐛 8 | 🌐 JavaScript | 📅 2024-11-28.
...
#### SLoc ([cloc](https://github.com/AlDanial/cloc#install-via-package-manager) ⭐ 23,557 | 🐛 26 | 🌐 Perl | 📅 2026-09-20)
...
* [ ] Using the OpenZeppelin safe math library \[[?](https://github.com/OpenZeppelin/openzeppelin-solidity/tree/master/contracts/math) ⭐ 27,256 | 🐛 357 | 🌐 Solidity | 📅 2026-09-25].
* [ ] Properly implements the ERC20 interface \[[?](https://github.com/ethereum/eips/issues/20) ⭐ 13,988 | 🐛 521 | 🌐 Python | 📅 2026-09-24].
...
* [TrailofBits](https://www.trailofbits.com)  : [Reports](https://github.com/trailofbits/publications) ⭐ 1,901 | 🐛 4 | 🌐 Python | 📅 2026-09-23
* [Oak Security](http://oaksecurity.io)  : [Reports](https://github.com/oak-security/audit-reports) ⭐ 166 | 🐛 0 | 📅 2026-09-24
...
* [All ctf poc writen using Foundery | ctf-blockchain)](https://github.com/minaminao/ctf-blockchain) ⭐ 1,100 | 🐛 0 | 🌐 Solidity | 📅 2025-10-09
...
* [Smart Contract Auditing Heuristics](https://github.com/OpenCoreCH/smart-contract-auditing-heuristics) ⭐ 619 | 🐛 0 | 📅 2022-12-13
* [Solidity idiosyncrasies](https://github.com/miguelmota/solidity-idiosyncrasies) ⚠️ Archived
* [Solidity Code Metrics By Consensys Diligence](https://github.com/ConsenSys/solidity-metrics) ⭐ 294 | 🐛 8 | 🌐 JavaScript | 📅 2024-11-28
