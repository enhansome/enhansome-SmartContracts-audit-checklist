...
#### SLoc ([cloc](https://github.com/AlDanial/cloc#install-via-package-manager) ⭐ 23,555 | 🐛 26 | 🌐 Perl | 📅 2026-09-20)
...
* [ ] Using the OpenZeppelin safe math library \[[?](https://github.com/OpenZeppelin/openzeppelin-solidity/tree/master/contracts/math) ⭐ 27,253 | 🐛 358 | 🌐 Solidity | 📅 2026-09-23].
* [ ] Properly implements the ERC20 interface \[[?](https://github.com/ethereum/eips/issues/20) ⭐ 13,984 | 🐛 524 | 🌐 Python | 📅 2026-09-21].
...
* [TrailofBits](https://www.trailofbits.com)  : [Reports](https://github.com/trailofbits/publications) ⭐ 1,899 | 🐛 5 | 🌐 Python | 📅 2026-09-23
